document.addEventListener('DOMContentLoaded', () => {
    ...
    const startBtn = document.querySelector('#stateBtn')
    ...
    function createGrid(){
        ...
        for (let i = 0; i < GRID_SIZE; i++) {
            let gridElement = document.createElement("div") //Create div
            grid.appendChild(gridElement) //Add div to .grid
        }
